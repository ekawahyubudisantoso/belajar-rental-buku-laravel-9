...
@section('container')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">List New Registered Users</h1>
    </div>
    ...
    <div class="table-responsive">
        <div class="d-flex justify-content-end mb-3">
            <a href="/dashboard/users" class="btn btn-primary">Active User</a>
        </div>
                ...
                @foreach ($users as $user)
                    <tr>
                        ...
                        <td>
                            ...
                            <form action="/dashboard/users/delete/{{ $user->slug }}" method="POST" class="d-inline">
                            @method('delete')
                            @csrf
